...
CREATE INDEX IF NOT EXISTS idx_analytics_product_id ON product_form_analytics(product_id);
CREATE INDEX IF NOT EXISTS idx_analytics_form_id ON product_form_analytics(form_id);
CREATE INDEX IF NOT EXISTS idx_analytics_advertiser_id ON product_form_analytics(advertiser_id);
CREATE INDEX IF NOT EXISTS idx_analytics_period ON product_form_analytics(period_start DESC);
