                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-center gap-2">
                                                <button 
                                                    ...
                                                    className="p-2 text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 rounded-lg transition-all hover:scale-110" 
                                                ...
                                                <button 
                                                    ...
                                                    className="p-2 text-slate-600 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg transition-all hover:scale-110" 
                                                    title="Edit Formulir"
                                                >
                                                    <PencilIcon className="w-5 h-5"/>
                                                </button>
                                                <button 
                                                    onClick={() => handleViewStandalone(form)} 
                                                    className="p-2 text-orange-600 hover:bg-orange-50 dark:hover:bg-orange-900/30 rounded-lg transition-all hover:scale-110" 
                                                    title="Lihat HTML"
                                                >
                                                    <CodeIcon className="w-5 h-5" />
                                                </button>
                                                <button 
                                                    onClick={() => setEditingTemplatesFor(form)} 
                                                    className="p-2 text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/30 rounded-lg transition-all hover:scale-110" 
                                                ...
                                                <button 
                                                    ...
                                                    className="p-2 text-green-600 hover:bg-green-50 dark:hover:bg-green-900/30 rounded-lg transition-all hover:scale-110" 
                                                    title="Salin Tautan"
                                                >
