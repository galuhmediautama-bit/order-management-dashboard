                        ...
                        {[
                            ...
                            return (
                                <button
                                    ...
                                    className={`whitespace-nowrap px-4 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-2 border shadow-sm hover:shadow-md ${isActive
                                ...
                                >
                                    {role.label}
                                    <span className={`px-2 py-0.5 rounded-md text-xs font-bold ${isActive ? 'bg-white/20 text-white' : 'bg-green-50 dark:bg-slate-700 text-green-600 dark:text-green-400'
                                        }`}>
                                        {role.count}
                                    </span>
                                </button>
